...
public struct ClientRequest: Codable, Sendable, ConvenienceCopyable, Equatable {
    ...
    public var windowId: UInt32??  // Please forward SCENEMUX_WINDOW_ID env variable here
    public var workspace: String?? // Please forward SCENEMUX_WORKSPACE env variable here
