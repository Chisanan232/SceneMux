...
let subcommandDescriptions = [
    ...
    ["  config", "Query SceneMux config options"],
    ...
    ["  enable", "Temporarily enable or disable SceneMux"],
    ...
    ["  home", "Show which Semantic Home an application’s windows belong to"],
    ...
    ["  trigger-binding", "Trigger SceneMux binding as if it was pressed by user"],
    ["  unmount", "Give the focused window back to where the Scene borrowed it from"],
